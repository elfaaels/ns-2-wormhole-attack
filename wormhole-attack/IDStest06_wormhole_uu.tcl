...
set w_n1 $node_(22)
set w_n2 $node_(25)
$ns_ ideal-wormhole-attach $w_n1 $w_n2
#$ns_ at 250.0 "[$w_n1 set wormhole_] start-wormhole-attack"
#$ns_ at 250.0 "[$w_n2 set wormhole_] start-wormhole-attack"
#$ns_ at 300.0 "[$w_n1 set wormhole_] stop-wormhole-attack"
#$ns_ at 300.0 "[$w_n2 set wormhole_] stop-wormhole-attack"
